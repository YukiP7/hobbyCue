        ...
        <div className="bg-purple-50 rounded-lg shadow-lg p-24 ">
          ...
          <div className="flex items-center justify-between mt-10 ">
            <div className="w-3/5 h-12 bg-purple-200 rounded-md flex items-center p-10">
              ...
              <img src={testimonialImage} alt="Shubha Nagarajan" className="w-12 h-12 rounded-full ml-4" />
            </div>
            <div className='flex gap-2 ml-0'>
            <img src={testimonialImage} alt="Shubha Nagarajan" className="w-24 h-24 rounded-full ml-4" />
